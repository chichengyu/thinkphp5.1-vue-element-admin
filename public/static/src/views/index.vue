...
<!--                <happy-scroll resize hide-horizontal color="rgba(0,0,0,.2)">-->
    ...
    methods: {
        ...
        getMenuAndTabBtnActiveStatus (currentName) {
            ...
            var flagLocal = this.siderList.some(sider => {
                ...
                if (currentName.includes(sider.name)) {
                    ...
                    var res = sider.children.some(item => {
                        ...
                        if (item.name && (currentName.includes(item.name))) {
            ...
            var tabBtnFlag = this.siderNameList.some(item => {
                ...
                if (currentName.includes(item.name)) {
...
.ivu-layout.ivu-layout-has-sider,.ivu-menu.ivu-menu-dark.ivu-menu-vertical.menu-item{
    width: 100% !important;
    height: 100%;
}
