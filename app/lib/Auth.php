...
CREATE TABLE `think_auth_rule` (
    ...
    `name` varchar(80) NOT NULL DEFAULT '' COMMENT '规则唯一标识user/add',
    `title` varchar(20) NOT NULL DEFAULT '' COMMENT '规则中文名称',
    `type` tinyint(1) NOT NULL DEFAULT '1',
    `status` tinyint(1) NOT NULL DEFAULT '1',
    `condition` varchar(20) NOT NULL DEFAULT '' COMMENT '规则表达式',  # 规则附件条件,满足附加条件的规则,才认为是有效的规则
    PRIMARY KEY (`id`),
...
class Auth
{
    ...
    protected $config = [
        ...
        'auth_rule' => 'store_auth_rule', // 权限规则表
        'auth_user' => 'store_personnel', // 用户信息表
    ];
